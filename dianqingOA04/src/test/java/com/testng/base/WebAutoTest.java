...
//		setDriver(initBrowser(browser));
		setDriver(SelectBrowserDriver.selectBrowser(browser));
...
//			String setscroll = "document.documentElement.scrollTop=" + height;
	 ...
	 */
	/*
	 * private static WebDriver initBrowser(String browser) { switch (browser) {
	 * case "ie": System.setProperty("webdriver.ie.driver",
	 * ".\\source\\IEDriverServer.exe"); setDriver(new InternetExplorerDriver());
	 * break; case "ff": case "firefox": case "Firefox": case "FireFox": //
	 * FireFox版本小于48 // System.setProperty("webdriver.firefox.marionette",
	 * ".\\Tools\\geckodriver.exe"); // FireFox版本大于48，默认安装时可以试试，应该可以 //
	 * System.setProperty("webdriver.gecko.driver", ".\\Tools\\geckodriver.exe"); //
	 * 自定义安装要这么写，使用上面的会报错找不到Firefox浏览器 System.setProperty("webdriver.firefox.bin",
	 * "E:\\Program Files (x86)\\Mozilla Firefox\\firefox.exe"); setDriver(new
	 * FirefoxDriver()); break; case "chrome": case "Chrome": //
	 * System.setProperty("webdriver.chrome.driver", ".\\Tools\\chromedriver.exe");
	 * System.setProperty("webdriver.chrome.driver",
	 * "E:/Program Files/Google/Chrome/Application/chromedriver.exe"); setDriver(new
	 * ChromeDriver()); break; default: try { throw new Exception("浏览器错误!"); } catch
	 * (Exception e) { e.printStackTrace(); } } return getDriver(); }
	 */
